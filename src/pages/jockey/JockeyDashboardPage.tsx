...
export function JockeyDashboardPage() {
  ...
  useEffect(() => {
    ...
    getRaceSchedule()
      ...
      .catch(() => setSchedule([]));
    getJockeyStats()
      .then((d: any) => setStats(d?.result ?? d ?? {}))
      .catch(() => setStats({}));
  }, []);
    ...
    <div className="min-h-screen text-body font-sans flex" style={{backgroundColor: '#0b101e'}}>
      ...
      <div className="flex-1 min-w-0 overflow-y-auto relative">
        ...
        <main className="relative z-10 max-w-[1600px] mx-auto px-8 py-6 space-y-6">
          ...
          {/* Stats — đua sắp tới (lọc isFuture) + số thắng thật từ getJockeyStats */}
          <motion.div variants={stagger} initial="hidden" animate="show" className="grid grid-cols-4 gap-4">
            {[
              ...
              { title: 'Số lần thắng',   value: String(stats.wins ?? '—'), trend: 'Mùa 2026',     icon: Trophy,   color: 'text-gold',       bg: 'from-gold/15 to-amber-900/20',      path: '/jockey/stats' },
