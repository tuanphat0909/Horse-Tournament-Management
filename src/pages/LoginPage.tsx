...
function HorseSVG() {
  return (
    <svg viewBox="0 0 200 150" fill="none" xmlns="http://www.w3.org/2000/svg"
         className="w-full h-full drop-shadow-[0_0_22px_rgba(201,168,76,0.45)]">
      <defs>
        <linearGradient id="gg" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#F0D080"/>
          <stop offset="50%" stopColor="#C9A84C"/>
          <stop offset="100%" stopColor="#8C702E"/>
        </linearGradient>
      </defs>
      <path
        ...
        fill="url(#gg)" stroke="#C9A84C" strokeWidth="1.5"/>
      <path d="M115,20 C105,15 95,20 85,30 C95,25 105,25 115,35" fill="none" stroke="#C9A84C" strokeWidth="1.5"/>
      <path d="M110,25 C100,20 90,25 80,35" fill="none" stroke="#C9A84C" strokeWidth="1.5"/>
      <path d="M20,85 C10,90 5,95 0,105 C10,100 20,95 30,95" fill="none" stroke="#C9A84C" strokeWidth="1.5"/>
      <path d="M25,80 C15,85 10,90 5,100" fill="none" stroke="#C9A84C" strokeWidth="1.5"/>
    </svg>
  );
}
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{
              backgroundImage: `url(${roleBackgrounds[selectedRole] || '/hero-bg.png'})`,
            }}
          />
        </AnimatePresence>
          ...
          >
            ...
            <div className="mb-10">
              <h1
                ...
                style={{ fontFamily: '"Playfair Display", serif', fontSize: '52px', lineHeight: '1.15' }}
              >
            ...
            >
              ...
              <div className="space-y-5 relative z-10">
                ...
                <motion.div variants={fadeUp} className="flex items-center justify-between text-sm">
                  <label className="flex items-center gap-2 cursor-pointer select-none text-muted hover:text-body transition-colors duration-200">
                    <input type="checkbox" className="rounded h-4 w-4 border-gold-border/50 text-gold bg-navy/60 focus:ring-0 focus:ring-offset-0 cursor-pointer" style={{ accentColor: '#C9A84C' }} />
                    <span>Remember me</span>
                  </label>
                  <a href="#" className="text-gold hover:text-champagne transition-colors duration-200">Forgot password?</a>
                </motion.div>
