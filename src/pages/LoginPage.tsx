...
export function LoginPage() {
  ...
  async function handleGoogleSuccess(credentialResponse: any) {
    ...
    try {
      ...
      const errorMsg = parseApiError(err as Error);
      setError(errorMsg);
      showToast('Sign-in error', errorMsg || 'Google authentication failed or the email was rejected by the system', 'error');
    } finally {
      setLoading(false);
    }
  }
  ...
  function handleGoogleError() {
    ...
    showToast('Sign-in error', 'Google authentication failed or the email was rejected by the system', 'error');
  }
