...
export function SpectatorLiveResultsPage() {
  ...
  const schedPg = paginate(schedule, schedPage, 6);
          ...
          <div>
            ...
            {scheduleLoading ? (
              ...
              <div className="space-y-3">
                ...
                <Pager page={schedPg.page} totalPages={schedPg.totalPages} total={schedPg.total} onChange={setSchedPage} />
              </div>
            )}
          </div>
