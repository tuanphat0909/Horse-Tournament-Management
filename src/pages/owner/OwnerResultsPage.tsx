              ...
              {loading ? (
                ...
                <div className="space-y-3">
                  {results.map((r, i) => {
                    ...
                    return (
                      <div key={r.id ?? i} className="flex items-center gap-4 p-4 rounded-xl bg-white/[0.02] border border-glass-border hover:border-gold/30 hover:bg-gold/[0.04] transition-all group">
