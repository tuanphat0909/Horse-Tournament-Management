...
import { getRegistrations, reviewRegistration } from '../../api/adminService';
...
export function AdminRegistrationsPage() {
  ...
  async function handleReview(id: number, status: 'Approved' | 'Rejected') {
    ...
    setReviewingId(id);
    try {
      await reviewRegistration(id, status);
      // Cập nhật ngay tại chỗ; vẫn tải lại để đồng bộ với BE
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {filtered.map((r, i) => {
                    ...
                    return (
                    <tr key={id ?? i} className="border-b border-glass-border/40 hover:bg-white/[0.02] transition-colors">
